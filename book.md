...
(임시)</br>
다운받은 Hi6 controller zip을 해제한 뒤에 가상 제어기와 tp를 실행 한다.# 1.4 python3 개발환경 설치
## python3 설치
...
- light-off 버튼 : ArgosX의 LED 조명을 끈다.# 3.2 ArgosX stub
...
![](../../_assets/image_26.png)# 3.3 argosx 프로젝트 생성
...
![](../../_assets/image_28.png)# 3.8 xhost 모듈의 method 참조설명서
...
</html># 3.9 로봇언어 함수 blocking 문제 해결
## blocking 문제
